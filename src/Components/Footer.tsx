...
const Footer = () => {
  return (
    <footer  className="bg-[#FFFFFF] flex flex-row justify-center py-10">
        <div className="flex flex-col items-left gap-4 md:gap-14 w-[100px] md:w-[600px]">
          ...
          <p className="w-[100px] md:w-[300px] pt-2 text-[8px] md:text-[20px] leading-normal text-[#777777]">
        ...
        <div className="flex flex-row gap-3 md:gap-32 text-[8px] md:text-[25px] w-[190px] md:w-[700px]">
